...
// Interface for Todo (matches ITodo in Task model)
interface Todo {
    text: string;
    completed: boolean;
  }
  // Interface for User (simplified for AvatarGroup)
  interface User {
    _id: string;
    name: string;
    avatar?: {
  ...
  interface TaskCardProps {
    ...
    todoChecklist: Todo[];
    onClick?: (event: MouseEvent<HTMLDivElement>) => void; // Optional click handler
  }
